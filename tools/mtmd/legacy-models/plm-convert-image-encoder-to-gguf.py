...
model = SiglipVisionModel.from_pretrained(dir_model, ignore_mismatched_sizes=True)
processor = None
...
if has_vision_encoder:
    ...
    fout.add_uint32("clip.vision.image_size", 384)
    fout.add_uint32("clip.vision.patch_size", 16)
...
use_relu2 = v_hparams["hidden_act"] == "relu2"
fout.add_bool("clip.use_gelu", use_relu2)
